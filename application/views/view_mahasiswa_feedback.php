    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                <li>
                    <a href="<?php echo base_url('HomeMahasiswa'); ?>"><span class="icon document" aria-hidden="true"></span>Submit Thesis</a>
                </li>
                <li>
                    <a class="active" href="<?php echo base_url('MahasiswaFeedback'); ?>"><span class="icon paper" aria-hidden="true"></span>  Feedback Dosen</a>
                </li>
          ...
          if (!empty($feedback)) {
              ...
              foreach ($feedback as $row) { ?>
                  <tr>
                      ...
                      <td><a class="aanyar" href="<?php echo base_url('MahasiswaFeedback/download/' . $row->id) ?>">Download</a></td>
                  </tr>
          <?php }
          } else {
