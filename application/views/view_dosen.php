          ...
          <table class="table table-hover table-bordered table-striped" id="table">
            ...
            foreach($mahasiswa as $row){ ?>
                <tr>
                    ...
                    <td><a class="aanyar" href="<?php echo base_url('DosenUpload/index/' . $row->id); ?>">Upload</a> | <a class="aanyar" href="<?php echo base_url('homedosen/download/' . $row->id); ?>">Download</a></td>
                </tr>
            <?php } ?>
            </tbody>
          </table>
